...
public:
	...
	virtual ~Girl() {}
	virtual void Load() = 0;
	void ShowGirl(int start, int end, int map, int maingirl_state, bool stop, int maingirl_left, bool beauty_time, bool evolution, int stop_man_left);
...
private:
	...
	void GirlMove(int start, int end, int map, int maingirl_state, bool evolution);
	bool left = false;
	int delay = 0;
};
